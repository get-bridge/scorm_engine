    ...
    module Endpoints
      module Courses
        module Configuration
          ...
          #
          # @see https://rustici-docs.s3.amazonaws.com/engine/2017.1.x/api.html#tenant__courses__courseId__configuration_get
          #
          # @param [Hash] options
          #
          ...
          #
          # @see https://rustici-docs.s3.amazonaws.com/engine/2017.1.x/api.html#tenant__courses__courseId__configuration_post
          #
          # @param [Hash] options
          #
          # @option options [String] :course_id
          ...
          #
          # @see https://rustici-docs.s3.amazonaws.com/engine/2017.1.x/api.html#tenant__courses__courseId__configuration__settingId__get
          #
          # @param [Hash] options
          #
          # @option options [String] :course_id
          ...
          #
          # @see https://rustici-docs.s3.amazonaws.com/engine/2017.1.x/api.html#tenant__courses__courseId__configuration__settingId__put
          #
          # @param [Hash] options
          #
          # @option options [String] :course_id
